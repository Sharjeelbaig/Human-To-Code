...
import { applyPatchAtomic, normalizePatchPath, PatchSafetyError, preparePatch, type PatchPolicy } from "../../pipeline/patch.ts";
...
import { buildGuidedPatchPrompt } from "../../prompts/guided-patch.ts";
import { buildGuidedRepairPrompt } from "../../prompts/guided-repair.ts";
import { cloneWorkspaceSnapshot, createWorkspaceSnapshot, disposeWorkspaceSnapshot, type WorkspaceSnapshot } from "../../pipeline/snapshot.ts";
import { strongSandboxAvailable, validateBaselineAndCandidate } from "../../pipeline/validation.ts";
import {
...
import type {
  GenerateRunOptions,
  ProviderCertificationV1,
  RunCertificationV1,
  ValidateStoredRunOptions,
  WorkflowOutcome,
} from "./types.ts";
import { renderPatchDiff } from "./patch-diff.ts";
import { assertExternalApisGrounded } from "./api-grounding.ts";
