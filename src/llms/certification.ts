...
import { SUPPORT_MATRIX, SUPPORT_MATRIX_VERSION } from "../tools/analysis/support-matrix.ts";
...
export function validateCertificationEvidenceV1(value: unknown): CertificationEvidenceV1 {
  ...
  if (record.ecosystem !== "react" && record.ecosystem !== "nestjs"
    && record.ecosystem !== "node" && record.ecosystem !== "fastapi"
    && record.ecosystem !== "rust" && record.ecosystem !== "general") {
